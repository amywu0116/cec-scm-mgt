          ...
          <Page style={styles.page} size="A4">
            <View style={{ flexDirection: "row" }}>
              <View style={{ flex: 1 }}>
                <View style={styles.delivery}>
                  <Text style={styles.deliveryText}>{info.shippingModel}</Text>
                </View>
            ...
            <View style={styles.checkoutSection}>
              ...
              <View style={styles.checkout}>
                ...
                >
                  ...
                  <Text style={{ flex: 1 }}>{numWithCommas(info.total)}</Text>
                </View>

                <View
                  style={[
                    styles.checkoutRow,
                    { borderTop: "1px solid #000", width: 350 },
                  ]}
                >
                ...
                <View style={[styles.checkoutRow, { width: 350 }]}>
                  ...
                  <Text style={{ flexBasis: "30px" }}>{info.taxableRate}</Text>
                ...
                <View style={[styles.checkoutRow, { width: 350 }]}>
                  ...
                  <Text style={{ flexBasis: "30px" }}>{info.untaxedRate}</Text>
                  <Text style={{ flexBasis: "120px" }}>
            ...
            <View style={styles.footer}>
              ...
              <View style={styles.websiteWrapper}>
                <Text>家樂福線上購物:https://online.carrefour.com.tw/</Text>
              </View>
            </View>
